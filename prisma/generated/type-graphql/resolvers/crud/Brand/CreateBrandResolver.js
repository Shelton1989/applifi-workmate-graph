...
exports.CreateBrandResolver = void 0;
...
let CreateBrandResolver = class CreateBrandResolver {
...
], CreateBrandResolver.prototype, "createBrand", null);
CreateBrandResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Brand_1.Brand)
], CreateBrandResolver);
exports.CreateBrandResolver = CreateBrandResolver;
