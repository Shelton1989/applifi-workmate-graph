...
exports.FindUniqueTenantResolver = void 0;
...
let FindUniqueTenantResolver = class FindUniqueTenantResolver {
...
], FindUniqueTenantResolver.prototype, "tenant", null);
FindUniqueTenantResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Tenant_1.Tenant)
], FindUniqueTenantResolver);
exports.FindUniqueTenantResolver = FindUniqueTenantResolver;
