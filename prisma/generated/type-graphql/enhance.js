...
const relationResolversInfo = {
    ...
    Experience: ["Tenant", "Availability", "AggregateRating", "LikedBy", "Locations", "Price", "Posts"],
...
const inputsInfo = {
    ...
    ExperienceWhereInput: ["AND", "OR", "NOT", "id", "Tenant", "tenantId", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ExperienceOrderByWithRelationInput: ["id", "Tenant", "tenantId", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceCreateInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ExperienceUpdateInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceCreateWithoutLikedByInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceCreateWithoutTenantInput: ["id", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceCreateWithoutAggregateRatingInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceUpdateWithoutAggregateRatingInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    UserCreateWithoutPostsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedExperiences", "experienceIds", "Requests", "Comments", "Replies", "Reactions", "Bookings", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutPostsInput: ["where", "create"],
    ExperienceCreateWithoutPostsInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "createdAt", "updatedAt"],
    ...
    ExperienceUpdateWithoutPostsInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "createdAt", "updatedAt"],
    ...
    ExperienceCreateWithoutAvailabilityInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ExperienceCreateOrConnectWithoutAvailabilityInput: ["where", "create"],
    ExperienceUpsertWithoutAvailabilityInput: ["update", "create"],
    ExperienceUpdateWithoutAvailabilityInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceCreateWithoutPriceInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceUpdateWithoutPriceInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceCreateWithoutLocationsInput: ["id", "Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceUpdateWithoutLocationsInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceUpdateWithoutLikedByInput: ["Tenant", "productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
    ...
    ExperienceUpdateWithoutTenantInput: ["productLink", "stripeProductId", "title", "description", "category", "Availability", "photo", "gallery", "duration", "AggregateRating", "publishStatus", "LikedBy", "likedByIds", "Locations", "Price", "Posts", "createdAt", "updatedAt"],
