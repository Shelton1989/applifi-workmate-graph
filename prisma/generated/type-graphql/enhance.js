...
const relationResolversInfo = {
    User: ["Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "Followers", "LikedProducts", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions"],
    ...
    Order: ["SelectedShippingAddress", "SelectedShippingMethod", "Buyer", "Seller", "Items"],
    Request: ["Reporter"],
...
const modelsInfo = {
    User: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt"],
    ...
    Product: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    ...
    Post: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    ...
    Order: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
...
const outputsInfo = {
    ...
    UserGroupBy: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    ProductGroupBy: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    PostGroupBy: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    OrderGroupBy: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    UserCount: ["Addresses", "Notifications", "Activity", "Following", "Followers", "LikedProducts", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions"],
    UserCountAggregate: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt", "_all"],
    UserMinAggregate: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
    UserMaxAggregate: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
    ...
    ProductCountAggregate: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt", "_all"],
    ProductAvgAggregate: ["availableQuantity"],
    ProductSumAggregate: ["availableQuantity"],
    ProductMinAggregate: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "baseProductId", "inventoryId", "createdAt", "updatedAt"],
    ProductMaxAggregate: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "baseProductId", "inventoryId", "createdAt", "updatedAt"],
    ...
    PostCountAggregate: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt", "_all"],
    PostMinAggregate: ["id", "type", "caption", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    PostMaxAggregate: ["id", "type", "caption", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    ...
    OrderCount: ["Items"],
    OrderCountAggregate: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt", "_all"],
    OrderMinAggregate: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    OrderMaxAggregate: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
...
const inputsInfo = {
    UserWhereInput: ["AND", "OR", "NOT", "uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserOrderByWithRelationInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserWhereUniqueInput: ["uid", "id", "username", "email"],
    UserOrderByWithAggregationInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt", "_count", "_max", "_min"],
    UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt"],
    ...
    ProductWhereInput: ["AND", "OR", "NOT", "id", "publishStatus", "description", "price", "priceId", "availableQuantity", "photo", "gallery", "BaseProduct", "baseProductId", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "inventoryId", "createdAt", "updatedAt"],
    ProductOrderByWithRelationInput: ["id", "publishStatus", "description", "price", "priceId", "availableQuantity", "photo", "gallery", "BaseProduct", "baseProductId", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "inventoryId", "createdAt", "updatedAt"],
    ProductWhereUniqueInput: ["id"],
    ProductOrderByWithAggregationInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
    ProductScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    ...
    PostWhereInput: ["AND", "OR", "NOT", "id", "type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "authorId", "Comments", "Reactions", "productLink", "createdAt", "updatedAt"],
    PostOrderByWithRelationInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "authorId", "Comments", "Reactions", "productLink", "createdAt", "updatedAt"],
    PostWhereUniqueInput: ["id"],
    PostOrderByWithAggregationInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt", "_count", "_max", "_min"],
    PostScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    ...
    OrderWhereInput: ["AND", "OR", "NOT", "id", "status", "SelectedShippingAddress", "selectedShippingAddressId", "SelectedShippingMethod", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "Buyer", "buyerId", "Seller", "sellerId", "Items", "createdAt", "updatedAt"],
    OrderOrderByWithRelationInput: ["id", "status", "SelectedShippingAddress", "selectedShippingAddressId", "SelectedShippingMethod", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "Buyer", "buyerId", "Seller", "sellerId", "Items", "createdAt", "updatedAt"],
    OrderWhereUniqueInput: ["id"],
    OrderOrderByWithAggregationInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt", "_count", "_max", "_min"],
    OrderScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    ...
    UserCreateInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserUpdateInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateManyInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt"],
    UserUpdateManyMutationInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt"],
    ...
    ProductCreateInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ProductUpdateInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ProductCreateManyInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    ProductUpdateManyMutationInput: ["publishStatus", "description", "availableQuantity", "photo", "gallery", "artworkIds", "colorIds", "sizeIds", "likedByIds", "createdAt", "updatedAt"],
    ...
    PostCreateInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "Comments", "Reactions", "productLink", "createdAt", "updatedAt"],
    PostUpdateInput: ["type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "Comments", "Reactions", "productLink", "createdAt", "updatedAt"],
    PostCreateManyInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    PostUpdateManyMutationInput: ["type", "caption", "mediaUrl", "isCommentsEnabled", "productLink", "createdAt", "updatedAt"],
    ...
    OrderCreateInput: ["id", "status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "Items", "createdAt", "updatedAt"],
    OrderUpdateInput: ["status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "Items", "createdAt", "updatedAt"],
    OrderCreateManyInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    ...
    UserCountOrderByAggregateInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt"],
    UserMaxOrderByAggregateInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
    UserMinOrderByAggregateInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
    ...
    ProductCountOrderByAggregateInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    ProductAvgOrderByAggregateInput: ["availableQuantity"],
    ProductMaxOrderByAggregateInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "baseProductId", "inventoryId", "createdAt", "updatedAt"],
    ProductMinOrderByAggregateInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "baseProductId", "inventoryId", "createdAt", "updatedAt"],
    ...
    PostCountOrderByAggregateInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    PostMaxOrderByAggregateInput: ["id", "type", "caption", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    PostMinOrderByAggregateInput: ["id", "type", "caption", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    ...
    OrderCountOrderByAggregateInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    OrderMaxOrderByAggregateInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    OrderMinOrderByAggregateInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    ...
    OrderCreateNestedManyWithoutBuyerInput: ["create", "connectOrCreate", "createMany", "connect"],
    OrderCreateNestedManyWithoutSellerInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    OrderUpdateManyWithoutBuyerInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    OrderUpdateManyWithoutSellerInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    PriceUpdateOneWithoutProductsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
    NullableIntFieldUpdateOperationsInput: ["set", "increment", "decrement", "multiply", "divide", "unset"],
    ProductUpdategalleryInput: ["set", "push"],
    BrandProductUpdateOneWithoutProductsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
    ...
    UserCreateNestedOneWithoutMyOrdersInput: ["create", "connectOrCreate", "connect"],
    UserCreateNestedOneWithoutPurchaseOrdersInput: ["create", "connectOrCreate", "connect"],
    ...
    UserUpdateOneRequiredWithoutMyOrdersInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    UserUpdateOneRequiredWithoutPurchaseOrdersInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ...
    UserCreateWithoutFollowersInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutFollowersInput: ["where", "create"],
    UserCreateWithoutFollowingInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutFollowingInput: ["where", "create"],
    ProductCreateWithoutLikedByInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    OrderCreateWithoutBuyerInput: ["id", "status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Seller", "Items", "createdAt", "updatedAt"],
    OrderCreateOrConnectWithoutBuyerInput: ["where", "create"],
    OrderCreateManyBuyerInputEnvelope: ["data"],
    OrderCreateWithoutSellerInput: ["id", "status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Items", "createdAt", "updatedAt"],
    OrderCreateOrConnectWithoutSellerInput: ["where", "create"],
    OrderCreateManySellerInputEnvelope: ["data"],
    ...
    PostCreateWithoutAuthorInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "Comments", "Reactions", "productLink", "createdAt", "updatedAt"],
    ...
    UserScalarWhereInput: ["AND", "OR", "NOT", "uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "followingIds", "followerIds", "productIds", "createdAt", "updatedAt"],
    ...
    ProductScalarWhereInput: ["AND", "OR", "NOT", "id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    InventoryUpsertWithoutUserInput: ["update", "create"],
    InventoryUpdateWithoutUserInput: ["Products", "Artwork", "createdAt", "updatedAt"],
    OrderUpsertWithWhereUniqueWithoutBuyerInput: ["where", "update", "create"],
    OrderUpdateWithWhereUniqueWithoutBuyerInput: ["where", "data"],
    OrderUpdateManyWithWhereWithoutBuyerInput: ["where", "data"],
    OrderScalarWhereInput: ["AND", "OR", "NOT", "id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    OrderUpsertWithWhereUniqueWithoutSellerInput: ["where", "update", "create"],
    OrderUpdateWithWhereUniqueWithoutSellerInput: ["where", "data"],
    OrderUpdateManyWithWhereWithoutSellerInput: ["where", "data"],
    ...
    PostScalarWhereInput: ["AND", "OR", "NOT", "id", "type", "caption", "mediaUrl", "isCommentsEnabled", "authorId", "productLink", "createdAt", "updatedAt"],
    ...
    ProductCreateWithoutInventoryInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutInventoryInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutInventoryInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateWithoutAddressesInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutAddressesInput: ["where", "create"],
    OrderCreateWithoutSelectedShippingAddressInput: ["id", "status", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "Items", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutAddressesInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutNotificationSettingsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutNotificationSettingsInput: ["where", "create"],
    UserUpsertWithoutNotificationSettingsInput: ["update", "create"],
    UserUpdateWithoutNotificationSettingsInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ProductCreateWithoutArtworkInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductCreateWithoutColorsInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductCreateWithoutSizesInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductCreateWithoutBaseProductInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutLikedProductsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    ProductCreateWithoutPriceInput: ["id", "publishStatus", "description", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    OrderCreateWithoutSelectedShippingMethodInput: ["id", "status", "SelectedShippingAddress", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "Items", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutPostsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutPostsInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    PostCreateWithoutCommentsInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "Reactions", "productLink", "createdAt", "updatedAt"],
    PostCreateOrConnectWithoutCommentsInput: ["where", "create"],
    UserCreateWithoutCommentsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    PostUpdateWithoutCommentsInput: ["type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "Reactions", "productLink", "createdAt", "updatedAt"],
    UserUpsertWithoutCommentsInput: ["update", "create"],
    UserUpdateWithoutCommentsInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutRepliesInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Reactions", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutRepliesInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Reactions", "createdAt", "updatedAt"],
    ...
    PostCreateWithoutReactionsInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "Comments", "productLink", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutReactionsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutReactionsInput: ["where", "create"],
    PostUpsertWithoutReactionsInput: ["update", "create"],
    PostUpdateWithoutReactionsInput: ["type", "caption", "mediaUrl", "isCommentsEnabled", "Author", "Comments", "productLink", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutReactionsInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "createdAt", "updatedAt"],
    ...
    ProductCreateWithoutOrderLineItemsInput: ["id", "publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    OrderCreateWithoutItemsInput: ["id", "status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "createdAt", "updatedAt"],
    ...
    ProductUpdateWithoutOrderLineItemsInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    OrderUpdateWithoutItemsInput: ["status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutMyOrdersInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutMyOrdersInput: ["where", "create"],
    UserCreateWithoutPurchaseOrdersInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutPurchaseOrdersInput: ["where", "create"],
    ...
    UserUpsertWithoutMyOrdersInput: ["update", "create"],
    UserUpdateWithoutMyOrdersInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserUpsertWithoutPurchaseOrdersInput: ["update", "create"],
    UserUpdateWithoutPurchaseOrdersInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutRequestsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutNotificationsInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Activity", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutNotificationsInput: ["where", "create"],
    UserCreateWithoutActivityInput: ["uid", "id", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutActivityInput: ["uid", "username", "email", "role", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "biography", "hasAcceptedTerms", "isFirstTimeUser", "Addresses", "NotificationSettings", "Notifications", "Following", "followingIds", "Followers", "followerIds", "LikedProducts", "productIds", "Inventory", "MyOrders", "PurchaseOrders", "Requests", "Posts", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    OrderCreateManyBuyerInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "sellerId", "createdAt", "updatedAt"],
    OrderCreateManySellerInput: ["id", "status", "selectedShippingAddressId", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "createdAt", "updatedAt"],
    ...
    PostCreateManyAuthorInput: ["id", "type", "caption", "mediaUrl", "isCommentsEnabled", "productLink", "createdAt", "updatedAt"],
    ...
    ProductUpdateWithoutLikedByInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    OrderUpdateWithoutBuyerInput: ["status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Seller", "Items", "createdAt", "updatedAt"],
    OrderUpdateWithoutSellerInput: ["status", "SelectedShippingAddress", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Items", "createdAt", "updatedAt"],
    ...
    PostUpdateWithoutAuthorInput: ["type", "caption", "mediaUrl", "isCommentsEnabled", "Comments", "Reactions", "productLink", "createdAt", "updatedAt"],
    ...
    ProductCreateManyInventoryInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "createdAt", "updatedAt"],
    ArtworkCreateManyInventoryInput: ["id", "title", "description", "caption", "url", "productIds", "createdAt", "updatedAt"],
    ProductUpdateWithoutInventoryInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "createdAt", "updatedAt"],
    ArtworkUpdateWithoutInventoryInput: ["title", "description", "caption", "url", "Products", "productIds", "OrderLineItems", "createdAt", "updatedAt"],
    OrderCreateManySelectedShippingAddressInput: ["id", "status", "selectedShippingMethodId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    OrderUpdateWithoutSelectedShippingAddressInput: ["status", "SelectedShippingMethod", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "Items", "createdAt", "updatedAt"],
    ...
    ProductUpdateWithoutArtworkInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductUpdateWithoutColorsInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductUpdateWithoutSizesInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductCreateManyBaseProductInput: ["id", "publishStatus", "description", "priceId", "availableQuantity", "photo", "gallery", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    ProductUpdateWithoutBaseProductInput: ["publishStatus", "description", "price", "availableQuantity", "photo", "gallery", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    ProductCreateManyPriceInput: ["id", "publishStatus", "description", "availableQuantity", "photo", "gallery", "baseProductId", "artworkIds", "colorIds", "sizeIds", "likedByIds", "inventoryId", "createdAt", "updatedAt"],
    ...
    ProductUpdateWithoutPriceInput: ["publishStatus", "description", "availableQuantity", "photo", "gallery", "BaseProduct", "Artwork", "artworkIds", "Colors", "colorIds", "Sizes", "sizeIds", "OrderLineItems", "LikedBy", "likedByIds", "Inventory", "createdAt", "updatedAt"],
    ...
    OrderCreateManySelectedShippingMethodInput: ["id", "status", "selectedShippingAddressId", "SelectedPaymentType", "stripePaymentReference", "buyerId", "sellerId", "createdAt", "updatedAt"],
    OrderUpdateWithoutSelectedShippingMethodInput: ["status", "SelectedShippingAddress", "SelectedPaymentType", "stripePaymentReference", "Buyer", "Seller", "Items", "createdAt", "updatedAt"],
