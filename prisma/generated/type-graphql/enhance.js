...
const crudResolversMap = {
    ...
    ProductKey: crudResolvers.ProductKeyCrudResolver,
...
const actionResolversMap = {
    ...
    ProductKey: {
        productKey: actionResolvers.FindUniqueProductKeyResolver,
        findFirstProductKey: actionResolvers.FindFirstProductKeyResolver,
        productKeys: actionResolvers.FindManyProductKeyResolver,
        createProductKey: actionResolvers.CreateProductKeyResolver,
        createManyProductKey: actionResolvers.CreateManyProductKeyResolver,
        deleteProductKey: actionResolvers.DeleteProductKeyResolver,
        updateProductKey: actionResolvers.UpdateProductKeyResolver,
        deleteManyProductKey: actionResolvers.DeleteManyProductKeyResolver,
        updateManyProductKey: actionResolvers.UpdateManyProductKeyResolver,
        upsertProductKey: actionResolvers.UpsertProductKeyResolver,
        aggregateProductKey: actionResolvers.AggregateProductKeyResolver,
        groupByProductKey: actionResolvers.GroupByProductKeyResolver
    },
    Comment: {
...
const crudResolversInfo = {
    ...
    ProductKey: ["productKey", "findFirstProductKey", "productKeys", "createProductKey", "createManyProductKey", "deleteProductKey", "updateProductKey", "deleteManyProductKey", "updateManyProductKey", "upsertProductKey", "aggregateProductKey", "groupByProductKey"],
...
const argsInfo = {
    ...
    FindUniqueProductKeyArgs: ["where"],
    FindFirstProductKeyArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyProductKeyArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    CreateProductKeyArgs: ["data"],
    CreateManyProductKeyArgs: ["data"],
    DeleteProductKeyArgs: ["where"],
    UpdateProductKeyArgs: ["data", "where"],
    DeleteManyProductKeyArgs: ["where"],
    UpdateManyProductKeyArgs: ["data", "where"],
    UpsertProductKeyArgs: ["where", "create", "update"],
    AggregateProductKeyArgs: ["where", "orderBy", "cursor", "take", "skip"],
    GroupByProductKeyArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const relationResolversMap = {
    ...
    ProductKey: relationResolvers.ProductKeyRelationsResolver,
...
const relationResolversInfo = {
    User: ["Tenant", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments"],
    NotificationSettings: ["User"],
    Tenant: ["Users", "Queries", "Documents", "Billing"],
    Billing: ["Tenant", "ProductKeys"],
    ProductKey: ["Billing"],
    ...
    Document: ["Tenant", "Comments", "CreatedBy"]
};
...
const modelsInfo = {
    ...
    Billing: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    ProductKey: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ...
    Document: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"]
};
...
const outputsInfo = {
    ...
    BillingGroupBy: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt", "_count", "_min", "_max"],
    AggregateProductKey: ["_count", "_min", "_max"],
    ProductKeyGroupBy: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    DocumentGroupBy: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt", "_count", "_min", "_max"],
    AffectedRowsOutput: ["count"],
    UserCount: ["Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments"],
    ...
    BillingCount: ["ProductKeys"],
    BillingCountAggregate: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt", "_all"],
    BillingMinAggregate: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    BillingMaxAggregate: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    ProductKeyCountAggregate: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt", "_all"],
    ProductKeyMinAggregate: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyMaxAggregate: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ...
    DocumentCountAggregate: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt", "_all"],
    DocumentMinAggregate: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    DocumentMaxAggregate: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"]
};
...
const inputsInfo = {
    UserWhereInput: ["AND", "OR", "NOT", "Tenant", "tenantId", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserOrderByWithRelationInput: ["Tenant", "tenantId", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    BillingWhereInput: ["AND", "OR", "NOT", "id", "Tenant", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKeys", "createdAt", "updatedAt"],
    BillingOrderByWithRelationInput: ["id", "Tenant", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKeys", "createdAt", "updatedAt"],
    BillingWhereUniqueInput: ["id", "tenantId"],
    BillingOrderByWithAggregationInput: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt", "_count", "_max", "_min"],
    BillingScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    ProductKeyWhereInput: ["AND", "OR", "NOT", "id", "Billing", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyOrderByWithRelationInput: ["id", "Billing", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyWhereUniqueInput: ["id", "key"],
    ProductKeyOrderByWithAggregationInput: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt", "_count", "_max", "_min"],
    ProductKeyScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ...
    DocumentWhereInput: ["AND", "OR", "NOT", "id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "tenantId", "Comments", "CreatedBy", "createdByUserId", "createdAt", "updatedAt"],
    DocumentOrderByWithRelationInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "tenantId", "Comments", "CreatedBy", "createdByUserId", "createdAt", "updatedAt"],
    DocumentWhereUniqueInput: ["id"],
    DocumentOrderByWithAggregationInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt", "_count", "_max", "_min"],
    DocumentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    UserCreateInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserUpdateInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    BillingCreateInput: ["id", "Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKeys", "createdAt", "updatedAt"],
    BillingUpdateInput: ["Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKeys", "createdAt", "updatedAt"],
    BillingCreateManyInput: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    BillingUpdateManyMutationInput: ["stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    ProductKeyCreateInput: ["id", "Billing", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyUpdateInput: ["Billing", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyCreateManyInput: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyUpdateManyMutationInput: ["createdBy", "key", "createdAt", "updatedAt"],
    ...
    DocumentCreateInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "Comments", "CreatedBy", "createdAt", "updatedAt"],
    DocumentUpdateInput: ["publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "Comments", "CreatedBy", "createdAt", "updatedAt"],
    DocumentCreateManyInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    DocumentUpdateManyMutationInput: ["publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "createdAt", "updatedAt"],
    ...
    ProductKeyListRelationFilter: ["every", "some", "none"],
    ProductKeyOrderByRelationAggregateInput: ["_count"],
    BillingCountOrderByAggregateInput: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    BillingMaxOrderByAggregateInput: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    BillingMinOrderByAggregateInput: ["id", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    ...
    ProductKeyCountOrderByAggregateInput: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyMaxOrderByAggregateInput: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyMinOrderByAggregateInput: ["id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    ...
    DocumentCountOrderByAggregateInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    DocumentMaxOrderByAggregateInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    DocumentMinOrderByAggregateInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    ...
    DocumentCreateNestedManyWithoutCreatedByInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    DocumentUpdateManyWithoutCreatedByInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    ProductKeyCreateNestedManyWithoutBillingInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    ProductKeyUpdateManyWithoutBillingInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    BillingCreateNestedOneWithoutProductKeysInput: ["create", "connectOrCreate", "connect"],
    BillingUpdateOneWithoutProductKeysInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
    ...
    UserCreateNestedOneWithoutCreatedDocumentsInput: ["create", "connectOrCreate", "connect"],
    ...
    UserUpdateOneWithoutCreatedDocumentsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
    ...
    DocumentCreateWithoutCreatedByInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "Comments", "createdAt", "updatedAt"],
    DocumentCreateOrConnectWithoutCreatedByInput: ["where", "create"],
    DocumentCreateManyCreatedByInputEnvelope: ["data"],
    ...
    DocumentUpsertWithWhereUniqueWithoutCreatedByInput: ["where", "update", "create"],
    DocumentUpdateWithWhereUniqueWithoutCreatedByInput: ["where", "data"],
    DocumentUpdateManyWithWhereWithoutCreatedByInput: ["where", "data"],
    DocumentScalarWhereInput: ["AND", "OR", "NOT", "id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdByUserId", "createdAt", "updatedAt"],
    UserCreateWithoutNotificationSettingsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutNotificationSettingsInput: ["where", "create"],
    UserUpsertWithoutNotificationSettingsInput: ["update", "create"],
    UserUpdateWithoutNotificationSettingsInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateWithoutTenantInput: ["uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    DocumentCreateWithoutTenantInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Comments", "CreatedBy", "createdAt", "updatedAt"],
    DocumentCreateOrConnectWithoutTenantInput: ["where", "create"],
    DocumentCreateManyTenantInputEnvelope: ["data"],
    BillingCreateWithoutTenantInput: ["id", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKeys", "createdAt", "updatedAt"],
    ...
    BillingUpdateWithoutTenantInput: ["stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKeys", "createdAt", "updatedAt"],
    ...
    ProductKeyCreateWithoutBillingInput: ["id", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyCreateOrConnectWithoutBillingInput: ["where", "create"],
    ProductKeyCreateManyBillingInputEnvelope: ["data"],
    ...
    ProductKeyUpsertWithWhereUniqueWithoutBillingInput: ["where", "update", "create"],
    ProductKeyUpdateWithWhereUniqueWithoutBillingInput: ["where", "data"],
    ProductKeyUpdateManyWithWhereWithoutBillingInput: ["where", "data"],
    ProductKeyScalarWhereInput: ["AND", "OR", "NOT", "id", "billingId", "createdBy", "key", "createdAt", "updatedAt"],
    BillingCreateWithoutProductKeysInput: ["id", "Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    BillingCreateOrConnectWithoutProductKeysInput: ["where", "create"],
    BillingUpsertWithoutProductKeysInput: ["update", "create"],
    BillingUpdateWithoutProductKeysInput: ["Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    DocumentCreateWithoutCommentsInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "CreatedBy", "createdAt", "updatedAt"],
    DocumentCreateOrConnectWithoutCommentsInput: ["where", "create"],
    UserCreateWithoutCommentsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    DocumentUpdateWithoutCommentsInput: ["publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "CreatedBy", "createdAt", "updatedAt"],
    UserUpsertWithoutCommentsInput: ["update", "create"],
    UserUpdateWithoutCommentsInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutRepliesInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutRepliesInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutReactionsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutReactionsInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateWithoutRequestsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutRequestsInput: ["where", "create"],
    UserUpsertWithoutRequestsInput: ["update", "create"],
    UserUpdateWithoutRequestsInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateWithoutNotificationsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutNotificationsInput: ["where", "create"],
    UserCreateWithoutActivityInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutActivityInput: ["where", "create"],
    UserUpsertWithoutNotificationsInput: ["update", "create"],
    UserUpdateWithoutNotificationsInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    UserUpsertWithoutActivityInput: ["update", "create"],
    UserUpdateWithoutActivityInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutQueriesInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserUpdateWithoutQueriesInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutCreatedDocumentsInput: ["Tenant", "uid", "uuid", "id", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutCreatedDocumentsInput: ["where", "create"],
    ...
    UserUpsertWithoutCreatedDocumentsInput: ["update", "create"],
    UserUpdateWithoutCreatedDocumentsInput: ["Tenant", "uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "createdAt", "updatedAt"],
    ...
    DocumentCreateManyCreatedByInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "tenantId", "createdAt", "updatedAt"],
    ...
    DocumentUpdateWithoutCreatedByInput: ["publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Tenant", "Comments", "createdAt", "updatedAt"],
    ...
    DocumentCreateManyTenantInput: ["id", "publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "createdByUserId", "createdAt", "updatedAt"],
    UserUpdateWithoutTenantInput: ["uid", "uuid", "username", "email", "roles", "firstName", "lastName", "avatar", "hasAcceptedTerms", "isFirstTimeUser", "isVerified", "isActive", "NotificationSettings", "Notifications", "Activity", "Queries", "Requests", "Comments", "Replies", "Reactions", "CreatedDocuments", "createdAt", "updatedAt"],
    LLMQueryUpdateWithoutTenantInput: ["queryLink", "question", "response", "createdAt", "updatedAt", "User"],
    DocumentUpdateWithoutTenantInput: ["publishStatus", "indexStatus", "title", "link", "url", "source", "shortDescription", "documentType", "Comments", "CreatedBy", "createdAt", "updatedAt"],
    ProductKeyCreateManyBillingInput: ["id", "createdBy", "key", "createdAt", "updatedAt"],
    ProductKeyUpdateWithoutBillingInput: ["createdBy", "key", "createdAt", "updatedAt"],
