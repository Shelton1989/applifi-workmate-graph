...
const modelsInfo = {
    ...
    ProductKey: ["id", "billingId", "key", "createdAt", "updatedAt"],
...
const outputsInfo = {
    ...
    ProductKeyGroupBy: ["id", "billingId", "key", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    ProductKeyCountAggregate: ["id", "billingId", "key", "createdAt", "updatedAt", "_all"],
    ProductKeyMinAggregate: ["id", "billingId", "key", "createdAt", "updatedAt"],
    ProductKeyMaxAggregate: ["id", "billingId", "key", "createdAt", "updatedAt"],
...
const inputsInfo = {
    ...
    BillingWhereInput: ["AND", "OR", "NOT", "id", "Tenant", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKey", "createdAt", "updatedAt"],
    BillingOrderByWithRelationInput: ["id", "Tenant", "tenantId", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKey", "createdAt", "updatedAt"],
    ...
    ProductKeyWhereInput: ["AND", "OR", "NOT", "id", "Billing", "billingId", "key", "createdAt", "updatedAt"],
    ProductKeyOrderByWithRelationInput: ["id", "Billing", "billingId", "key", "createdAt", "updatedAt"],
    ProductKeyWhereUniqueInput: ["id", "billingId", "key"],
    ProductKeyOrderByWithAggregationInput: ["id", "billingId", "key", "createdAt", "updatedAt", "_count", "_max", "_min"],
    ProductKeyScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "billingId", "key", "createdAt", "updatedAt"],
    ...
    BillingCreateInput: ["id", "Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKey", "createdAt", "updatedAt"],
    BillingUpdateInput: ["Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKey", "createdAt", "updatedAt"],
    ...
    ProductKeyCreateInput: ["id", "Billing", "key", "createdAt", "updatedAt"],
    ProductKeyUpdateInput: ["Billing", "key", "createdAt", "updatedAt"],
    ProductKeyCreateManyInput: ["id", "billingId", "key", "createdAt", "updatedAt"],
    ProductKeyUpdateManyMutationInput: ["key", "createdAt", "updatedAt"],
    ...
    ProductKeyRelationFilter: ["is", "isNot"],
    ...
    ProductKeyCountOrderByAggregateInput: ["id", "billingId", "key", "createdAt", "updatedAt"],
    ProductKeyMaxOrderByAggregateInput: ["id", "billingId", "key", "createdAt", "updatedAt"],
    ProductKeyMinOrderByAggregateInput: ["id", "billingId", "key", "createdAt", "updatedAt"],
    ...
    ProductKeyCreateNestedOneWithoutBillingInput: ["create", "connectOrCreate", "connect"],
    ...
    ProductKeyUpdateOneWithoutBillingInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
    BillingCreateNestedOneWithoutProductKeyInput: ["create", "connectOrCreate", "connect"],
    BillingUpdateOneRequiredWithoutProductKeyInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ...
    BillingCreateWithoutTenantInput: ["id", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKey", "createdAt", "updatedAt"],
    ...
    BillingUpdateWithoutTenantInput: ["stripeCustomerId", "stripeSubscriptionId", "plan", "status", "ProductKey", "createdAt", "updatedAt"],
    ...
    ProductKeyCreateWithoutBillingInput: ["id", "key", "createdAt", "updatedAt"],
    ...
    ProductKeyUpsertWithoutBillingInput: ["update", "create"],
    ProductKeyUpdateWithoutBillingInput: ["key", "createdAt", "updatedAt"],
    BillingCreateWithoutProductKeyInput: ["id", "Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
    BillingCreateOrConnectWithoutProductKeyInput: ["where", "create"],
    BillingUpsertWithoutProductKeyInput: ["update", "create"],
    BillingUpdateWithoutProductKeyInput: ["Tenant", "stripeCustomerId", "stripeSubscriptionId", "plan", "status", "createdAt", "updatedAt"],
