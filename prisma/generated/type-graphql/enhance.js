...
const outputsInfo = {
    ...
    UserMinAggregate: ["uid", "id", "username", "email", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
    UserMaxAggregate: ["uid", "id", "username", "email", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
...
const inputsInfo = {
    ...
    UserMaxOrderByAggregateInput: ["uid", "id", "username", "email", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
    UserMinOrderByAggregateInput: ["uid", "id", "username", "email", "firstName", "lastName", "avatar", "coverImage", "dateOfBirth", "hasAcceptedTerms", "isFirstTimeUser", "createdAt", "updatedAt"],
