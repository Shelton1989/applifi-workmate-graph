...
const crudResolversMap = {
    ...
    Query: crudResolvers.QueryCrudResolver,
...
const actionResolversMap = {
    ...
    Query: {
        query: actionResolvers.FindUniqueQueryResolver,
        findFirstQuery: actionResolvers.FindFirstQueryResolver,
        queries: actionResolvers.FindManyQueryResolver,
        createQuery: actionResolvers.CreateQueryResolver,
        createManyQuery: actionResolvers.CreateManyQueryResolver,
        deleteQuery: actionResolvers.DeleteQueryResolver,
        updateQuery: actionResolvers.UpdateQueryResolver,
        deleteManyQuery: actionResolvers.DeleteManyQueryResolver,
        updateManyQuery: actionResolvers.UpdateManyQueryResolver,
        upsertQuery: actionResolvers.UpsertQueryResolver,
        aggregateQuery: actionResolvers.AggregateQueryResolver,
        groupByQuery: actionResolvers.GroupByQueryResolver
    },
    Document: {
...
const crudResolversInfo = {
    ...
    Query: ["query", "findFirstQuery", "queries", "createQuery", "createManyQuery", "deleteQuery", "updateQuery", "deleteManyQuery", "updateManyQuery", "upsertQuery", "aggregateQuery", "groupByQuery"],
...
const argsInfo = {
    ...
    FindUniqueQueryArgs: ["where"],
    FindFirstQueryArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    FindManyQueryArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
    CreateQueryArgs: ["data"],
    CreateManyQueryArgs: ["data"],
    DeleteQueryArgs: ["where"],
    UpdateQueryArgs: ["data", "where"],
    DeleteManyQueryArgs: ["where"],
    UpdateManyQueryArgs: ["data", "where"],
    UpsertQueryArgs: ["where", "create", "update"],
    AggregateQueryArgs: ["where", "orderBy", "cursor", "take", "skip"],
    GroupByQueryArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const modelsInfo = {
    ...
    Query: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    Document: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"]
};
...
const outputsInfo = {
    ...
    AggregateQuery: ["_count", "_min", "_max"],
    QueryGroupBy: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId", "_count", "_min", "_max"],
    AggregateDocument: ["_count", "_min", "_max"],
    DocumentGroupBy: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    QueryCountAggregate: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId", "_all"],
    QueryMinAggregate: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    QueryMaxAggregate: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    DocumentCount: ["Comments"],
    DocumentCountAggregate: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt", "_all"],
    DocumentMinAggregate: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    DocumentMaxAggregate: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"]
};
...
const inputsInfo = {
    ...
    QueryWhereInput: ["AND", "OR", "NOT", "id", "Tenant", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "User", "userId"],
    QueryOrderByWithRelationInput: ["id", "Tenant", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "User", "userId"],
    QueryWhereUniqueInput: ["id"],
    QueryOrderByWithAggregationInput: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId", "_count", "_max", "_min"],
    QueryScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    DocumentWhereInput: ["AND", "OR", "NOT", "id", "publishStatus", "title", "shortDescription", "Tenant", "tenantId", "Comments", "createdAt", "updatedAt"],
    DocumentOrderByWithRelationInput: ["id", "publishStatus", "title", "shortDescription", "Tenant", "tenantId", "Comments", "createdAt", "updatedAt"],
    DocumentWhereUniqueInput: ["id"],
    DocumentOrderByWithAggregationInput: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt", "_count", "_max", "_min"],
    DocumentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    ...
    QueryCreateInput: ["id", "Tenant", "queryLink", "queryText", "createdAt", "updatedAt", "User"],
    QueryUpdateInput: ["Tenant", "queryLink", "queryText", "createdAt", "updatedAt", "User"],
    QueryCreateManyInput: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    QueryUpdateManyMutationInput: ["queryLink", "queryText", "createdAt", "updatedAt"],
    DocumentCreateInput: ["id", "publishStatus", "title", "shortDescription", "Tenant", "Comments", "createdAt", "updatedAt"],
    DocumentUpdateInput: ["publishStatus", "title", "shortDescription", "Tenant", "Comments", "createdAt", "updatedAt"],
    DocumentCreateManyInput: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    DocumentUpdateManyMutationInput: ["publishStatus", "title", "shortDescription", "createdAt", "updatedAt"],
    ...
    QueryListRelationFilter: ["every", "some", "none"],
    ...
    QueryOrderByRelationAggregateInput: ["_count"],
    ...
    QueryCountOrderByAggregateInput: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    QueryMaxOrderByAggregateInput: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    QueryMinOrderByAggregateInput: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    EnumPUBLISH_STATUSFilter: ["equals", "in", "notIn", "not"],
    DocumentCountOrderByAggregateInput: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    DocumentMaxOrderByAggregateInput: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    DocumentMinOrderByAggregateInput: ["id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    ...
    QueryCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    QueryUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    QueryCreateNestedManyWithoutTenantInput: ["create", "connectOrCreate", "createMany", "connect"],
    ...
    QueryUpdateManyWithoutTenantInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    QueryCreateWithoutUserInput: ["id", "Tenant", "queryLink", "queryText", "createdAt", "updatedAt"],
    QueryCreateOrConnectWithoutUserInput: ["where", "create"],
    QueryCreateManyUserInputEnvelope: ["data"],
    ...
    QueryUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
    QueryUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
    QueryUpdateManyWithWhereWithoutUserInput: ["where", "data"],
    QueryScalarWhereInput: ["AND", "OR", "NOT", "id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    ...
    QueryCreateWithoutTenantInput: ["id", "queryLink", "queryText", "createdAt", "updatedAt", "User"],
    QueryCreateOrConnectWithoutTenantInput: ["where", "create"],
    QueryCreateManyTenantInputEnvelope: ["data"],
    DocumentCreateWithoutTenantInput: ["id", "publishStatus", "title", "shortDescription", "Comments", "createdAt", "updatedAt"],
    ...
    QueryUpsertWithWhereUniqueWithoutTenantInput: ["where", "update", "create"],
    QueryUpdateWithWhereUniqueWithoutTenantInput: ["where", "data"],
    QueryUpdateManyWithWhereWithoutTenantInput: ["where", "data"],
    ...
    DocumentScalarWhereInput: ["AND", "OR", "NOT", "id", "publishStatus", "title", "shortDescription", "tenantId", "createdAt", "updatedAt"],
    ...
    DocumentCreateWithoutCommentsInput: ["id", "publishStatus", "title", "shortDescription", "Tenant", "createdAt", "updatedAt"],
    ...
    DocumentUpdateWithoutCommentsInput: ["publishStatus", "title", "shortDescription", "Tenant", "createdAt", "updatedAt"],
    ...
    QueryCreateManyUserInput: ["id", "tenantId", "queryLink", "queryText", "createdAt", "updatedAt"],
    ...
    QueryUpdateWithoutUserInput: ["Tenant", "queryLink", "queryText", "createdAt", "updatedAt"],
    ...
    QueryCreateManyTenantInput: ["id", "queryLink", "queryText", "createdAt", "updatedAt", "userId"],
    DocumentCreateManyTenantInput: ["id", "publishStatus", "title", "shortDescription", "createdAt", "updatedAt"],
    ...
    QueryUpdateWithoutTenantInput: ["queryLink", "queryText", "createdAt", "updatedAt", "User"],
    DocumentUpdateWithoutTenantInput: ["publishStatus", "title", "shortDescription", "Comments", "createdAt", "updatedAt"],
